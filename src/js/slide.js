...
$.ajax({
    ...
    success: function (result) {
        $.each(result.slideValue, function (index, img) { //index是循环的序数
            var slideValue = result.slideValue[index].value;
            var slideImg = result.slideValue[index].img;
            //console.log(slideValue); 
            $(`
            <li class="carousel-item"><a href="${slideValue}"><img src="${slideImg}" /></a></li>
